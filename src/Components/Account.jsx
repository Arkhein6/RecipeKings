                ...
                <div className="w-[500px] h-[500px] rounded-lg border border-gray-200 self-center flex justify-around flex-col shadow-2xl ">
                        ...
                        <>
                            {!emailRegisterSwitch ? (
                                ...
                                <form
                                    ...
                                    id="signup_forms"
                                    className="flex justify-center flex-col content-center mx-16 gap-2">
                                    ...
                                    <div className=" text-center">
                                        <input
                                            className="mt-2 w-full block border rounded-lg py-2  px-4 bg-yellow-500"
                                            type="submit"
                                            value="Submit"
                                        />
                                    </div>
                        ...
                        <form
                            ...
                            <div className="flex justify-center flex-col content-center mx-16 gap-2">
                                ...
                                <div className="text-center w-full">
                                    <input
                                        className="mt-2 w-full block border rounded-lg py-2 bg-yellow-500"
                                        type="submit"
                                        value="Sign in"
                                        formMethod="dialog"
                                    />
                    ...
                    {emailRegisterSwitch && (
                        <div className="text-center text-sm mx-10">
                            ...
                            RecipeKings <u>Privacy Policy</u> applies to you
                        </div>
                    )}
                </div>
            </section>
